...
from mmimproc.io.images import savenii, loadStack
...
from mmimproc.projects.scs.file_names import project, SubjIdPicks, get_spgr_names, Optsd, merge_ftempl_dicts
# set up provenance
