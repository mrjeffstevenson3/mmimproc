...
from mmimproc.utils import ProvenanceWrapper, getnetworkdataroot, appendposix, bumptodefunct, WorkingContext, run_subprocess, mmimproc_dir
...
corr_fpgm = mmimproc_dir / 'mmimproc/projects/nbwr/mrs/nbwr_spreadsheet_sep27_correlations_13_3'
plot_fpgm = mmimproc_dir / 'mmimproc/projects/nbwr/mrs/makeplots_nbwr.txt'
