...
from mmimproc.projects.bbc.pairing import dwi_fsl_wls_tensor_mf_fnames, dwi2templ_warp_fnames, dwi2templ_affine_fnames
from mmimproc.utils import appendposix
