...
#list2=sub-bbc243_ses-1_dti_15dir_b1000_1_withmf3S0_ec_thr1_mori_Left_SLF-43-81-83_UKF.vtk
...
rm mori.*
cp ../../*mori.nii mori.nii
fslhd -x mori > mori_hdr.txt

grep sto_ijk mori_hdr.txt > z.txt
