# first runs for acdc freesurf script. now includes making bem surfs
import mmimproc
...
import datetime
import mne, json
from mmimproc.projects.acdc.file_names import project, SubjIdPicks, get_freesurf_names
from mmimproc.utils.paths import getnetworkdataroot, get_antsregsyn_cmd
from mmimproc.structural.brain_extraction import extract_brain
from mmimproc.fmap_correction.b1_map_corr import correct_img4b1
from mmimproc.utils import run_subprocess, WorkingContext, appendposix, replacesuffix
...
# instantiate subject id dictionary container
