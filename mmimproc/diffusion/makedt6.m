There is some lines below where they read in the eigenvalue files such as L1, L2, L3 and 
the eigenvector files called V1, V2, V3.  Can you see this part of the code below?
Todd
