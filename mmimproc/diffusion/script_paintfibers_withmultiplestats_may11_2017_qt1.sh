...
rm stats1*
cp mean_scsqT1_reg2bbctemplate_reg2bbc253subjspace.nii.gz stats1.nii.gz
...
${PYLABS}/pylabs/diffusion/writefiber_withpaint_with_multiplestats_may09_2017_qt1
cp fnew.vtk ${afile/.vtk/_stats_qt1.vtk}
fi
