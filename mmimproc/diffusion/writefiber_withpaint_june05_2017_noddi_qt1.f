c gfortran  -O3 -mcmodel=medium -g writefiber_withpaint_june05_2017_noddi_qt1.f -o writefiber_withpaint_june05_2017_noddi_qti -ffixed-line-length-none
...
c
	...
	real poly(9),dnmrsav(9500000,10), polysav(9500000,5,4),tensors(9500000,9)
	real polyfinal(9500000,5)
...
c
	...
	iy = nint(ry)
	iz = nint(rz)
	if(polysav(i,1,1).lt.0.0)then
	tensors(i,1) = dti(ix,iy,iz,1)  !left side of the brain
	else
	tensors(i,1) = 0.0     !right side of the brain set to 0
	endif
c
