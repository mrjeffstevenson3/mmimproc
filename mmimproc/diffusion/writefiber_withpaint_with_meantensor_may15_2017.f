c gfortran  -O3 -mcmodel=medium -g writefiber_withpaint_with_meantensor_may15_2017.f -o writefiber_withpaint_with_meantensor_may15_2017 -ffixed-line-length-none
...
c	write(6,*)'distance ',dnmr(i),i,ipsize
	...
	enddo
	do i=1,isize
	if(vtk(i).eq.'s'.and.vtk(i+1).eq.'o'.and.vtk(i+2).eq.'r')then
	iset = i
	write(6,*)'find sors',iset,i,(vtk(ii),ii=i-15,i+5)
	endif
	enddo
	do i=iset,iset+100
	write(6,*)'vtk ivtk ',vtk(i),ivtk(i),i,i-iset
	enddo
...
c	if(tensors(i,1).eq.2.0)write(6,*)'found fa1 1',i,ifinalcount
	...
	write(6,*)'icountbytes after tensor',icountbytes
c
	close(31)
