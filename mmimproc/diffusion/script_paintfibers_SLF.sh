...
sub131=SLF-131
cd ${DATADIR}/bbc
#list=`python -c "from mmimproc.projects.bbc.pairing import dwipairing; \
...
#rm -f *_channel*
list2=`ls /mnt/users/js/bbc/sub-bbc253/ses-1/stats_in_subj_space/toddtest/sub-bbc253_ses-1_dti_15dir_b1000_1_withmf3S0_ec_thr1_mori_Left_SLF-43-81-83_UKF.vtk`
...
cp fnew.vtk /mnt/users/js/bbc/sub-bbc253/ses-1/stats_in_subj_space/toddtest/sub-bbc253_ses-1_dti_15dir_b1000_1_withmf3S0_ec_thr1_mori_Left_SLF-43-81-83_UKF_channelfixed.vtk
echo -n "${afile} " >> ${DATADIR}/bbc/allukf_channel_run${run}.txt
fi
