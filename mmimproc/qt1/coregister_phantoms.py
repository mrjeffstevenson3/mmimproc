...
import mmimproc.alignment.phantom
from mmimproc.utils.paths import getlocaldataroot
from mmimproc.qt1.naming import qt1filepath
...
def coregisterPhantoms(uncoregfiles, projectdir, overwrite=False, dirstruct='BIDS'):
    ...
    for f, image in enumerate(uncoregfiles):
        ...
        try:
            xform = mmimproc.alignment.phantom.align(subjectfile, targetfile, delta=10)
            mmimproc.alignment.phantom.savetransformed(subjectfile, xform, newFile, newAffine)
...
#xaffine = mmimproc.alignment.spaces.xform2affine(**xform)
#xform = {
#    'tx':x,
#    'ty':y,
#    'rxy':r,
