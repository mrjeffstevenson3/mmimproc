...
c
	...
	numcol = 17
	numrows = 38
	open(11,file = 'for_todd_FSLcorrected_metabolites.csv')
	...
	close(11)
	open(11,file = 'prepare_for_r_choline_fsl.txt')
	write(11,*)'choline, group'
c
c  nbwr med group
c
	c3(1) = '007'
