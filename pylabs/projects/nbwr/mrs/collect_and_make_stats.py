...
fstats.to_excel(writer, sheet_name='stats', index_label='stats', header=True, startrow=9, startcol=0, data_format)
worksheet.write_string(22,0,stats_hdrs['descriptive'], title_format)
descriptives.to_excel(writer, sheet_name='stats', index_label='stats', header=True, startrow=24, startcol=0, data_format)
