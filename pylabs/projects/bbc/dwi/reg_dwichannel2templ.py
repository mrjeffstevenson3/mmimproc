...
# fitmethsd = {'OLS': ['ols_dipy_medfilt', 'ols_fsl_tensor_medfilt'],
#             'WLS': ['wls_dipy_medfilt', 'wls_fsl_tensor_medfilt']}
    ...
    for k, fm in fitmethsd.iteritems():
        for f in fm:
            for a, c in channel_atlases.iteritems():
                ...
                outf = (fs / project / 'reg' / 'dwi_warps_in_template_space' / 'comb_FA_AD_RD_MD_4vol' / outf_fmat.format(dwif=dwif, f=f, a=a))
                ...
                execwdir = fs / project / 'reg' / 'dwi_warps_in_template_space' / 'comb_FA_AD_RD_MD_4vol'
