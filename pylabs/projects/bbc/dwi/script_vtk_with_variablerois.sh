...
if [[ "$afile" == *"$subcc"* ]]; then
    ...
    fslmaths ${afile/.vtk/_channel.nii.gz} -bin ${afile/.vtk/_Forceps_Major_channel.nii.gz}
    ...
    fslmaths ${afile/.vtk/_Forceps_Minor_channel.nii.gz} -bin ${afile/.vtk/_Forceps_Minor_channel_bin.nii.gz}
