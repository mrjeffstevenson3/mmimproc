...
Corrected p-value: 0.000917577195188
Corresponding t-value: 4.86
tneg = t.copy()
tpos = t.copy()
tneg[tneg>0] = 0
tneg = numpy.abs(tneg)
...
outfnames = {var:{var[1]} for var in variables.columns.values}
...
FA4D_img = nib.Nifti1Image(data4d, affine)
nib.save(FA4D_img, str(outdir / 'all_foster_FA.nii'))
