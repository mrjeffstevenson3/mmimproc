c
c program to test DTI qc using the correlation between adjacent slices method described
c by the DTIprep program from NITRC
c
c input files needed for this program are:
c dtishort.hdr which needs to be float 32bit
c dtishort.img
c alphalevel.txt
c bvals
