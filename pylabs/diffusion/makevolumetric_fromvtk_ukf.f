...
c	write(6,*)'vtk ivtk ',vtk(i),ivtk(i),i,i-iset
	...
	do i=iset+5,iset+50
	if(ivtk(i).eq.10)then
	write(6,*)'found endmarker for tensor for fa2 ',i
	imarktensor = i
	endif
	enddo
	endif
...
c	write(6,*)'vtk ivtk ',vtk(i),ivtk(i),i,i-iset
	...
	do i=iset+5,iset+50
	if(ivtk(i).eq.10)then
	write(6,*)'found endmarker for tensor for ror ',i
	imarktensor = i
	endif
	enddo
	endif
...
c	write(6,*)'vtk ivtk ',vtk(i),ivtk(i),i,i-iset
	...
	do i=iset+5,iset+50
	if(ivtk(i).eq.10)then
	write(6,*)'found endmarker for EstimatedUncertainty ',i
	imarktensor = i
	endif
	enddo
	endif
...
c  start section for trace2
	do i=1,isize
	if(vtk(i).eq.'C'.and.vtk(i+1).eq.'E'.and.vtk(i+2).eq.'2'.and.vtk(i+3).eq.' ')then
	iset = i
	write(6,*)'find float ',iset,i,(vtk(ii),ii=i-15,i+5)
	endif
	enddo
...
c	write(6,*)'vtk ivtk ',vtk(i),ivtk(i),i,i-iset
	...
	do i=iset+5,iset+50
	if(ivtk(i).eq.10)then
	write(6,*)'found endmarker for freewater ',i
	imarktensor = i
	endif
	enddo
	endif
...
c	write(6,*)'rfa1 axial radial rmd volumeratio ',r1,r2,r3,rfa1,axial,radial,rmd,volumeratio,i
	...
	dnmrsav(ireg,10)=tensors(i,1,8)+ dnmrsav(ireg,10) !trac1
...
c
	...
	do ireg=1,10
	write(12,*)(dnmrsav(ireg,ii),ii=1,12)
	enddo
	close(12)
