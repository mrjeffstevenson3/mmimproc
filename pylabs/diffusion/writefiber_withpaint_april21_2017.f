c gfortran  -O3 -mcmodel=medium -g writefiber_withpaint_april21_2017.f -o writefiber_withpaint_april32_2017 -ffixed-line-length-none
...
c
	...
	if(dti(iix,iiy,iiz,1).eq.326)then
	write(6,*)'found stats ',iix,iiy,iiz
	tensors(i,1) = 2.0
	endif
	enddo  !iix
	enddo  !iiy
