...
cp usechannel.txt /mnt/users/js/bbc/Slicer_scenes/Slicer_mean_tensor_slf_roi_7am_5-15-2017/toddtest
cp procmethod.txt /mnt/users/js/bbc/Slicer_scenes/Slicer_mean_tensor_slf_roi_7am_5-15-2017/toddtest
...
${PYLABS}/pylabs/diffusion/writefiber_withpaint_with_meantensor_may15_2017
