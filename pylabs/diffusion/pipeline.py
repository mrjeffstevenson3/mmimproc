...
matfilerootdir = tbssdir+'matfiles/'
resultdir = tbssdir+'randpar/{0}/'.format(exptag)
...
matfiles = csv2fslmat(csvfile, tag=exptag, cols=range(5, 39), 
    covarcols=[2, 41], selectSubjects=subjects, groupcol=True, 
    workdir=matfilerootdir, opts=opts)
