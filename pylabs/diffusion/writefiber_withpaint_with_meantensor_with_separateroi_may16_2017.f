...
c
	...
	if(dti(i,j,k,1).eq.ibrainreg1.and.dti(i,j,k,2).ne.ibrainreg2.and.dti(i,j,k,3).ne.ibrainreg3)dti(i,j,k,7)=1.0
	if(dti(i,j,k,1).ne.ibrainreg1.and.dti(i,j,k,2).eq.ibrainreg2.and.dti(i,j,k,3).ne.ibrainreg3)dti(i,j,k,7)=2.0
	if(dti(i,j,k,1).ne.ibrainreg1.and.dti(i,j,k,2).ne.ibrainreg2.and.dti(i,j,k,3).eq.ibrainreg3)dti(i,j,k,7)=3.0
	if(dti(i,j,k,4).eq.ibrainreg4)dti(i,j,k,7)=4.0
	if(dti(i,j,k,5).eq.11169.0)dti(i,j,k,7)=5.0
	if(dti(i,j,k,1).eq.ibrainreg1.and.dti(i,j,k,4).eq.ibrainreg4)dti(i,j,k,7)=6.0
	enddo
	enddo
	enddo
