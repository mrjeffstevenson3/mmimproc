...
def getnetworkdataroot(verbose=True):
    ...
    if pylabs.datadir.target == 'kl4' and any(x in hostname for x in ['Jeffs-MacBook-Pro-3.local', 'Jeffs-MBP-3',
    ...
    if pylabs.datadir.target == 'js5' and any(x in hostname for x in ['Jeffs-MacBook-Pro-3.local', 'Jeffs-MBP-3',
                                       'Jeffs-MacBook-Pro.local' , '.dhcp4.washington.edu']):
