...
from ._dirs import InDir, InTempDir, appendposix, replacesuffix, removesuffix, prependposix, insertdir  # noqa
...
from .paths import RootDataDir, getnetworkdataroot, moriMNIatlas, JHUMNIatlas, pylabs_atlasdir, pylabs_dir, pylabs_datadir, getspmpath #noqa
