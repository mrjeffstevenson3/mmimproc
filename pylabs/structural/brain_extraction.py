...
struc_betDict[('sub-2013-C053', 'ses-1', 'anat')]['sub-2013-C053_ses-1_3dt2_1']['bet_com'] = (79, 95, 151)
struc_betDict[('sub-2013-C053', 'ses-1', 'anat')]['sub-2013-C053_ses-1_3dt2_1']['zcutoff'] = (75)
...
def struc_bet(key1, key2, key3, niftiDict, frac=0.25):
    ...
    fslbet.inputs.center = [x for x in struc_betDict[key1][key2]['bet_com']]
